...
class LogCompanionStaticVerboseTest {
    ...
    fun test_vIsLoggable() {
        assertThat(LogCompanionStatic.vIsLoggable())
            .isTrue()
    }

    @Test
    fun test_vIsLoggableTagNull() {
        assertThat(LogCompanionStatic.vIsLoggableTagNull())
            .isTrue()
    }

    @Test
    fun test_v2() {
        LogCompanionStatic.v2()
    ...
    fun test_v3MessageNull() {
        LogCompanionStatic.v3MessageNull()
        assertThat(tree.stack).containsOnly(
            TimberRecord.exception(
                Log.VERBOSE,
                LogCompanionStatic.TAG,
    ...
    fun test_v3ThrowableNull() {
        LogCompanionStatic.v3ThrowableNull()
        assertThat(tree.stack).containsOnly(
            TimberRecord(
                Log.VERBOSE,
                LogCompanionStatic.TAG,
    ...
    @Test
    fun test_v3TagOnly() {
        LogCompanionStatic.v3TagOnly()
        assertThat(tree.stack).isEmpty()
    }

    @Test
    fun test_v3TagNull() {
        LogCompanionStatic.v3TagNull()
        assertThat(tree.stack).containsOnly(
            TimberRecord.exception(
                Log.VERBOSE,
                LogCompanionStatic.TAG,
    ...
    fun test_v3ThrowableOnly() {
        LogCompanionStatic.v3ThrowableOnly()
        assertThat(tree.stack).containsOnly(
            TimberRecord.exception(
                Log.VERBOSE,
                LogCompanionStatic.TAG,
    ...
    fun test_v3MessageOnly() {
        LogCompanionStatic.v3MessageOnly()
        assertThat(tree.stack).containsOnly(
            TimberRecord(
                Log.VERBOSE,
                LogCompanionStatic.TAG,
