...
class LogCompanionStaticDebugTest {
    ...
    fun test_dIsLoggable() {
        assertThat(LogCompanionStatic.dIsLoggable())
            .isTrue()
    }

    @Test
    fun test_dIsLoggableTagNull() {
        assertThat(LogCompanionStatic.dIsLoggableTagNull())
            .isTrue()
    }

    @Test
    fun test_d2() {
        LogCompanionStatic.d2()
    ...
    fun test_d3MessageNull() {
        LogCompanionStatic.d3MessageNull()
        assertThat(tree.stack).containsOnly(
            TimberRecord.exception(
                Log.DEBUG,
                LogCompanionStatic.TAG,
    ...
    fun test_d3ThrowableNull() {
        LogCompanionStatic.d3ThrowableNull()
        assertThat(tree.stack).containsOnly(
            TimberRecord(
                Log.DEBUG,
                LogCompanionStatic.TAG,
    ...
    @Test
    fun test_d3TagOnly() {
        LogCompanionStatic.d3TagOnly()
        assertThat(tree.stack).isEmpty()
    }

    @Test
    fun test_d3TagNull() {
        LogCompanionStatic.d3TagNull()
        assertThat(tree.stack).containsOnly(
            TimberRecord.exception(
                Log.DEBUG,
                LogCompanionStatic.TAG,
    ...
    fun test_d3ThrowableOnly() {
        LogCompanionStatic.d3ThrowableOnly()
        assertThat(tree.stack).containsOnly(
            TimberRecord.exception(
                Log.DEBUG,
                LogCompanionStatic.TAG,
    ...
    fun test_d3MessageOnly() {
        LogCompanionStatic.d3MessageOnly()
        assertThat(tree.stack).containsOnly(
            TimberRecord(
                Log.DEBUG,
                LogCompanionStatic.TAG,
