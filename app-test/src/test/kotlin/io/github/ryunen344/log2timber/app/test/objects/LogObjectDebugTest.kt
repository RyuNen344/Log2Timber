...
class LogObjectDebugTest {
    ...
    fun test_dIsLoggable() {
        assertThat(LogObject.dIsLoggable())
            .isTrue()
    }

    @Test
    fun test_dIsLoggableTagNull() {
        assertThat(LogObject.dIsLoggableTagNull())
            .isTrue()
    }
