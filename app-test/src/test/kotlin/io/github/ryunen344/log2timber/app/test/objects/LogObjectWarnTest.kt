...
class LogObjectWarnTest {
    ...
    fun test_wIsLoggable() {
        assertThat(LogObject.wIsLoggable())
            .isTrue()
    }

    @Test
    fun test_wIsLoggableTagNull() {
        assertThat(LogObject.wIsLoggableTagNull())
            .isTrue()
    }
