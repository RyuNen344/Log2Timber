...
class LogCompanion {
    companion object {
        const val TAG = $$"LogCompanion$Companion"
        const val MESSAGE = $$"LogCompanion$Companion message"
        val throwable = IllegalStateException($$"LogCompanion$Companion exception")
