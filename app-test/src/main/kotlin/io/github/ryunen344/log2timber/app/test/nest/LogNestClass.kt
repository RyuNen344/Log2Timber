...
package io.github.ryunen344.log2timber.app.test.nest
...
class LogNestClass {
    ...
    companion object {
        const val TAG = $$"LogNestClass$InnerClass"
        const val MESSAGE = $$"LogNestClass$InnerClass message"
        val throwable = IllegalStateException($$"LogNestClass$InnerClass exception")
    }
}
